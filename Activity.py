...
def view_my_playlist():
    ...
    print(f"Total: {len(my_playlist)} songs")
...
def find_common_songs():
    ...
    common = my_playlist.intersection(friend_songs)
...
def find_unique_songs():
    ...
    only_mine = my_playlist - friend_songs

    # TODO: Find songs in FRIEND's playlist but NOT in yours
    only_theirs = friend_songs - my_playlist
...
def get_recommendations():
    ...
    recommendations = all_friend_songs - my_playlist
...
def combine_playlists():
    ...
    combined = my_playlist | friend_songs
...
def mark_favorites():
    ...
    while True:
        ...
        if song in my_playlist:
            ...
            print(f'{song} must be in your playlist to add to favorites')
...
def view_stats():
    ...
    (len(favorites) / len(my_playlist)) * 100
    ...
    for friend, songs in friends_playlists.items():
        ...
        common = my_playlist.intersection(songs)
